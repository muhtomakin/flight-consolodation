...
def scrape_flights(sections):
    ...
    data = addFlightsInfo(times, stops, company, durations, prices)
...
def scrape_hotels_opodo(sections):
    info = copy(initial_info_hotels)
    data = []
    name = []
    reviewsScore = []
